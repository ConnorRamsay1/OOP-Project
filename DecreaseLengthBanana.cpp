...
DecreaseLengthBanana::DecreaseLengthBanana(Color color1, Color color2,
                                           Vector2 position,
                                           int _DecreaseAmount) {
...
// Setters-----------------------------------------
void DecreaseLengthBanana::setDecreaseAmount(int _DecreaseAmount) {
  this->_DecreaseAmount = _DecreaseAmount;
}
void DecreaseLengthBanana::setPosition(Vector2 position) {
  this->position = position;
}
...
void DecreaseLengthBanana::draw(int cellSize) {
  ...
  BananaDraw(cellSize, cellSize / 2, getInsideColour(), getOutsideColour(),
             screenPos);
}

// Random position avoiding snake
Vector2 DecreaseLengthBanana::GenerateRandomPos(int cellNum,
                                                const Snake& snake) {
